  ...
  return (
    <section className="contact-section">
      <div className="contact-header">
        <h1>Get in Touch</h1>
        <p>
          Have questions about AI-driven farming? Need personalized advice?
          We're here to help your farm thrive with technology.
        </p>
      </div>
      ...
      <div className="contact-container">
        <div className="contact-info">
          ...
          <div className="info-item">
            ...
            <div className="info-content">
              <h3>Visit Us</h3>
              <p>123 Farm Tech Avenue</p>
              <p>Agricultural Valley, CA 95123</p>
            </div>
          </div>
          ...
          <div className="contact-map">
            <div className="map-placeholder">
              ...
              <span>FarmingAI Headquarters</span>
            </div>
          </div>
        </div>
        ...
        <div className="contact-form-container">
          ...
          {formStatus.submitted && (
            <div
              className={`form-alert ${formStatus.error ? "error" : "success"}`}
            >
              {!formStatus.error && <FaCheck className="alert-icon" />}
              {formStatus.message}
            </div>
          )}
      ...
      <div className="contact-connect">
        ...
        <p>
          Follow us on social media for the latest updates, farming tips, and AI
          technology insights.
        </p>
